...
const API_KEY = "48f4c409185d1e958bd69a3d4497d7b5"; // API key for OpenWeatherMap API
...
const createWeatherCard = (cityName, weatherItem, index) => {
    if (index === 0) {
        ...
        return `
            ...
            <div class="icon">
              <img
                src="https://openweathermap.org/img/wn/${weatherItem.weather[0].icon
            }@4x.png"
                alt="weather-icon"
              />
...
const getCityCoordinates = () => {
    ...
    fetch(GEOCODING_API_URL)
        .then((res) => res.json())
        .then((data) => {
            if (!data.length) return alert("city not found in ${cityName}");
